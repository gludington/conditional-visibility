      ...
      this.sumo = {
        ...
        createElems() {
          ...
          if (settings.outputAsCSV && O.is_multi && O.E.attr('name')) {
            ...
            O.select.append(
              $('<input class="HEMANT123" type="hidden" />').attr('name', O.E.attr('name')).val(O.getSelStr()),
            );
        ...
        Search() {
          ...
          O.ftxt = $('<input type="text" class="search-txt" value="" autocomplete="off">').on('click', (e) => {
            e.stopPropagation();
          });
        ...
        toggSel(c, i) {
          ...
          if (opt.selected !== c) {
            if (
              (settings.max && !opt.selected && O.selectedCount < settings.max) ||
              opt.selected ||
        ...
        toggSelAll(c, direct) {
          ...
          if (O.is_multi) {
            ...
            if (c) {
              O.E.find('option')
                .toArray()
                .filter((option) => !option.selected && !option.disabled && option.style.display !== 'none')
                .forEach((option) => {
